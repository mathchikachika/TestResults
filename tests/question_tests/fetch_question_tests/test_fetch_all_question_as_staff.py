...
def test_reported_status_mathworld_type_ror_response_page_1(get_staff_token):
    ...
    response_type: str = "Range Open Response"
    page_num: int = 1
    mathworld_response: dict = common.create_a_mathworld_question("staff", response_type)
...
def test_approved_status_college_type_mc_response_page_1(get_staff_token):
    req: Requester = Requester()
    headers: dict = req.create_basic_headers(token=get_staff_token)
    question_status: str = "Approved"
    question_type: str = "College Level"

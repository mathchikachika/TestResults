...
def test_question_fetch_by_uuid_status_pending(get_admin_token):
...
def test_question_fetch_by_uuid_status_rejected(get_admin_token):
    req: Requester = Requester()    
    headers: dict = req.create_basic_headers(token=get_admin_token)
...
def test_question_fetch_by_uuid_status_approved(get_admin_token):
    req: Requester = Requester()    
    headers: dict = req.create_basic_headers(token=get_admin_token)
...
def test_question_fetch_by_uuid_status_reported(get_admin_token):
    req: Requester = Requester()    
    headers: dict = req.create_basic_headers(token=get_admin_token)
...
def test_question_fetch_by_invalid_uuid_format(get_admin_token):
    req: Requester = Requester()    
    headers: dict = req.create_basic_headers(token=get_admin_token)
    question_status: str = "Reported"
    questions_returned: list = execute_query(
...
def test_question_fetch_by_invalid_uuid_data(get_admin_token):
    req: Requester = Requester()    
    headers: dict = req.create_basic_headers(token=get_admin_token)
    question_status: str = "Reported"
    questions_returned: list = execute_query(
...
def test_question_fetch_by_uuid_invalid_token(get_admin_token):
    req: Requester = Requester()    
